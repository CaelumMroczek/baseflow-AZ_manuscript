...
-   A machine learning model (XGBoost) successfully predicted long-term BFI in ungauged basins, addressing gaps in a sparse low-flow streamgage network, typical of drylands.
...
The study area represents a range of heterogeneous climate, elevation,
