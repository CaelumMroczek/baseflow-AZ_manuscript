...
![Mean annual BFI for the period of record from instrumented stream flow data.](images/BFI_Instrumented_20241126.png){#fig-instrumented-bfi}
...
| Group                              | n   | n_pos | n_neg | perc_pos | perc_neg |
|------------------------------------|-----|-------|-------|----------|----------|
...
| Classification Group               | n    | R^2^  | MSE    | RMSE  | MAE   | NSE   | pbias |
|----------------|--------|--------|--------|--------|--------|--------|--------|
| Precipitation - Monsoon Dominated  | 3345 | 0.707 | 0.0166 | 0.129 | 0.077 | 0.694 | -12.6 |
| Precipitation - Snowmelt Dominated | 6152 | 0.723 | 0.017  | 0.131 | 0.094 | 0.715 | -3.7  |
