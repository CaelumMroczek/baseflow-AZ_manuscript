...
![Predicted mean annual BFI values for 8-digit HUC (1991-2020)](images/BFI_HUC8_20241203.png){#fig-bfi-huc}

![Predicted mean annual BFI values for all reaches of Strahler stream order 3 and greater](images/BFI_AllStream.png){#fig-bfi-streams}
