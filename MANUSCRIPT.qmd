...
While there has been an increase of stream gages in Arizona to comply with regulatory imperatives, such as the Clean Water Act, these gages are not of sufficient quality for base-flow analyses. New, non-USGS stream gages are typically installed by flood control districts for flood flow monitoring, and do not accurately track base flow. New USGS stream gages have been added over the past 10 years to address instream flow rights and to improve the density of monitoring in the future.
